...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.FURNI_EDITOR_SEARCH_RESULT, FurniEditorSearchEvent);
        this._events.set(IncomingHeader.FURNI_EDITOR_DETAIL_RESULT, FurniEditorDetailEvent);
        this._events.set(IncomingHeader.FURNI_EDITOR_INTERACTIONS_RESULT, FurniEditorInteractionsEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.FURNI_EDITOR_CREATE, FurniEditorCreateComposer);
