...
export class OctaneMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.VARIABLE_FX_CONFIG_UPDATE, VariableFxConfigUpdateEvent);
        this._events.set(IncomingHeader.VARIABLE_FX_CONFIG_REMOVE, VariableFxConfigRemoveEvent);
        this._events.set(IncomingHeader.VARIABLE_FX_STATUS_UPDATE, VariableFxStatusUpdateEvent);
        this._events.set(IncomingHeader.VARIABLE_FX_STATUS_REMOVE, VariableFxStatusRemoveEvent);
